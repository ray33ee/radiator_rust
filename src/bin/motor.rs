...
impl<'a> Motor<'a> {
    pub fn new<P1: OutputPin + 'a, P2: OutputPin + 'a, P3: OutputPin + 'a, P4: OutputPin + 'a>(p1: P1, p2: P2, p3: P3, p4: P4, store: &'a SdInterface<'a>) -> Self {
